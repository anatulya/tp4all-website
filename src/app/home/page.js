    ...
    return (
        <div>
            <div className="flex flex-col sm:mt-8 space-y-4">
                ...
                <div className={`flex flex-row items-center text-lg sm:pb-2 ${inconsolata.className}`}>
                    ...
                    <div className="grid grid-cols-5 sm:gap-8 sm:mt-2">
                    <div className="sm:col-span-3">
                        <ImageGallery font={inconsolata.className} />
                    </div>
                    <div className="col-span-full sm:col-span-2 flex flex-col  text-neutral-100">
                        <div className=" flex flex-col sm:flex-row justify-between pb-8 sm:pb-0 text-white">
                            <h1 className="font-semibold text-2xl">Events</h1>
                            <Link href="/events" className="sm:bg-transparent sm:px-0 w-fit bg-red-600 px-4">
                                <div className="inline-flex flex-row items-center sm:hover:text-red-500 sm:hover:fill-red-500 fill-white">
            ...
            <div className={` flex flex-col mt-10 ${inter.className}`}>
                ...
                <h1 className="font-semibold text-2xl">Upcoming Projects</h1>
                  <Link href="" className="sm:bg-transparent sm:px-0 w-fit bg-red-600 px-4">
                                <div className="inline-flex flex-row items-center sm:hover:text-red-500 sm:hover:fill-red-500 fill-white">
                                    <h1 className=" text-lg">See All</h1>
                                    <svg className="" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0z" fill="none" /><path d="M16.01 11H4v2h12.01v3L20 12l-3.99-4z" /></svg>
                                </div>
                ...
                <div className="flex-col">
                    <div className="grid sm:grid-cols-3 mt-16  sm:mt-8">
