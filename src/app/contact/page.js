    ...
    return (
        <div className="flex flex-col mt-8 space-y-4">
            ...
            <div className="flex flex-col">
                ...
                <h1>Email: <Link target="_blank"  href="mailto:thinkpads4all@gmail.com"  className={`text-red-500 hover:text-red-400`} >thinkpads4all@gmail.com</Link></h1>
                <h1>Instagram: <Link target="_blank" href="https://www.instagram.com/thinkpads4all"  className={`text-red-500 hover:text-red-400`}>@thinkpads4all</Link></h1>
                <h1>LinkedIn: <Link target="_blank" href="https://www.linkedin.com/company/thinkpads4all" className={`text-red-500 hover:text-red-400`}  >linkedin.com/company/thinkpads4all/</Link></h1>
