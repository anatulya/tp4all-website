    ...
    return (
        ...
        <div className="flex flex-row gap-8 flex-wrap justify-center">
            ...
            <a href="/gallery/cupertino" className="group">
                <div className="flex flex-col ">
                    ...
                    <div className="w-64 h-64  rounded-lg group-hover:outline outline-2 outline-neutral-300 " style={{ backgroundImage: "url(/cupertino/thumbnail.jpg)" }} />
            ...
            <a href="/gallery/milpitas" className="group">
                <div className="flex flex-col ">
                    {/* <img src="/milpitas/thumbnail.jpg" className="rounded-lg" /> */}
                    <div className="w-64 h-64 rounded-lg group-hover:outline outline-2 outline-neutral-300" style={{ backgroundImage: "url(/milpitas/thumbnail.jpg)" }} />
                    <div className="pt-2 text-white font-semibold">Milpitas Library</div>
                    <div className="text-neutral-300 font-semibold text-sm">30-35 attendees</div>
	    ...
	    <div className="">
	    	<a href="/gallery/burlingame" className="group">
	        	<div className="flex flex-col ">
	                        {/* <img src="/milpitas/thumbnail.jpg" className="rounded-lg" /> */}
				<div className="w-64 h-64 rounded-lg group-hover:outline outline-2 outline-neutral-300" style={{ backgroundImage: "url(/burlingame/thumbnail.jpg)" }} />
            ...
            <a href="/gallery/saratoga" className="group">
                <div className="flex flex-col ">
                    {/* <img src="/milpitas/thumbnail.jpg" className="rounded-lg" /> */}
                    <div className="w-64 h-64  rounded-lg group-hover:outline outline-2 outline-neutral-300" style={{ backgroundImage: "url(/saratoga/thumbnail.jpg)" }} />
            ...
            <a href="/gallery/gilroy" className="group">
                <div className="flex flex-col ">
                    {/* <img src="/milpitas/thumbnail.jpg" className="rounded-lg" /> */}
                    <div className="w-64 h-64  rounded-lg group-hover:outline outline-2 outline-neutral-300" style={{ backgroundImage: "url(/gilroy/thumbnail.jpg)" }} />
            ...
            <a href="/gallery/los_altos" className="group">
                <div className="flex flex-col ">
                    {/* <img src="/milpitas/thumbnail.jpg" className="rounded-lg" /> */}
                    <div className="w-64 h-64  rounded-lg group-hover:outline outline-2 outline-neutral-300" style={{ backgroundImage: "url(/los_altos/thumbnail.jpg)" }} />
            ...
            <a href="/gallery/morgan_hill" className="group">
                <div className="flex flex-col ">
                    {/* <img src="/milpitas/thumbnail.jpg" className="rounded-lg" /> */}
                    <div className="w-64 h-64  rounded-lg group-hover:outline outline-2 outline-neutral-300" style={{ backgroundImage: "url(/morgan_hill/thumbnail.jpg)" }} />
