...
export const EventPageClient = ({ inconsolata, inter }) => {
    return (
        <div className={`flex flex-col text-white ${inconsolata}`}>
            ...
            <h1 className={`mt-8 font-semibold text-2xl ${inter}`}>Past Events</h1>
            <EventListing name={"Cupertino Library"} date={new Date(2025, 2, 22, 14)} link={"gallery/cupertino"} city={"Cupertino, CA"} />
